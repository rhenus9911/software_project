...
from recomm_service import foodRecommand
...
def table_info(dong):
    sales_dict, den_dict, card_dict, pop_dict = foodRecommand(dong)
...
#=============================================================================
    ...
    # 이미지 2장, dict 4개를 최종 반환
    return sales_img, density_img, trans_sales, trans_den, card_dict, pop_dict